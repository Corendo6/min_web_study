...
<script>
	$(document).ready(function() {
		...
		$("#set_data").click(function() {
			...
			// a태그 링크 형태로 d1에 추가하기
			$("#d1").html("<a href='https://naver.com'>NAVER</a>");
			
			$("#d2").html("<img src='../images/googlelogo_color_272x92dp.png'>");
			$("#d2>img").css("width", "272px");
		});
		
		$("#get_data").click(function() {
			// id가 name인 폼에서 데이터를 가져와 id가 getName인 폼에 넣기

$(document).ready(function() {
	...
	let code = "<h1>" + boxOffice.boxofficeType + "</h1>" + "<h3>" + boxOffice.showRange + "</h3>";
	code += "<table><tr><th>순위</th><th>제목</th><th>개봉일</th><th>관객 수</th><th>매출액</th><th>누적관객</th></tr>";
	boxOffice.dailyBoxOfficeList.forEach(function(value, index) {
	code += "<tr>";
	code += "<td>" + value.rank + "</td>";	
	code += "<td>" + value.movieNm + "</td>";
	code += "<td>" + value.openDt + "</td>";
	code += "<td>" + value.audiCnt + "</td>";
	code += "<td>" + value.salesAmt + "</td>";
	code += "<td>" + value.audiAcc + "</td>";
	code += "</tr>";
	});
	code += "</table>";
	$("body").append(code);
